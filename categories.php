            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="page-breadcrumb">
                        ...
                        <a href="#">Home</a>
                        <a href="#">Vestidos</a>
                        <a class="active" href="#">Vestidos de noche</a>
                    </div>
                </div>
                <div class="col-lg-8">
            ...
            <div class="more-product">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <a href="#" class="primary-btn">Cargar más</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container text-center pt-5">
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Clothes Shop by Yalixa Viquez
