            ...
            <div class="inner-header">
                ...
                <nav class="main-menu mobile-menu">
                    <ul>
                        ...
                        <li><a href="./categories.php">Comprar</a>
                            <ul class="sub-menu">
                                <li><a href="product-page.php">Productos</a></li>
                                <li><a href="shopping-cart.php">Tarjeta de compras</a></li>
                                <li><a href="check-out.php">Revisar</a></li>
                            </ul>
                        </li>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="single-box-item first-box">
                                    ...
                                    <div class="box-text">
                                        <span class="trend-year">Fiestas 2020</span>
                                        <h2>Joyería</h2>
                                        <span class="trend-alert">Alarma de tendencia</span>
                                        <a href="#" class="primary-btn">Ver más</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="single-box-item second-box">
                                    ...
                                    <div class="box-text">
                                        <span class="trend-year">Tendencias 2020</span>
                                        <h2>Calzado</h2>
                    ...
                    <div class="col-lg-6">
                        <div class="single-box-item large-box">
                            ...
                            <div class="box-text">
                                <span class="trend-year">Fiestas 2020</span>
                                <h2>Colección</h2>
                                <div class="trend-alert">En tendencia</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row" id="product-list">
                ...
                <div class="col-lg-3 col-sm-6 mix all dresses bags">
                    <div class="single-product-item">
                        <figure>
                            ...
                            <div class="p-status sale">Rebaja</div>
                        </figure>
                        <div class="product-text">
                            <h6>Vestido largo amarillo (Maxi Dress)</h6>
                            <p>₡30.000</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-sm-6 mix all dresses shoes">
                    <div class="single-product-item">
                        ...
                        <div class="product-text">
                            <h6>Vestido verde con detalles</h6>
                            <p>$22.90</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-4 offset-lg-1">
                    <div class="lookbok-left">
                        ...
                        <p>Los nombres más importantes de la moda han reescrito su definición de glamour moderno para la Primavera-Verano 2020
                            para incluir un toque hecho a mano. Tan poco pretencioso como puede ser el crochet de lujo, ciertamente no está hecho para la playa.
                            En cambio, deja que estos tejidos abiertos inspiren tu atuendo de lujo para la oficina o para un coctel al llegar la primavera.</p>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form action="#">
                            ...
                            <button type="submit">Suscribirse a nuestro boletín de noticias</button>
                        </form>
                    </div>
                </div>
            </div>
